...
// controller to get recommended users for the logged in user
...
// controller to get the friends of logged in user
...
export async function acceptFriendRequest(req, res) {
  try {
    ...
    // add each user to the other's friends array , because they are now friends.
...
// controller to get incoming friend requests for logged in user
